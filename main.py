...
def add_comment(intent, session):
    ...
    # If no feed_id set, let's try to get one
   # if "facebook_feed_id" not in session.get('attributes', {}):
   #     get_feed(session)
   #     print("Get feed in add_comment")
    ...
    if 'Comment' in intent['slots']:
        ...
        speech_output = "I added, " + comment + \
                        ". Do you want to get next?"

        # Add comment
        fu.put_comment(facebook_id, comment)
